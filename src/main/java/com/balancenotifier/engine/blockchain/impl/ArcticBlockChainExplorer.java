...
@Component
@Qualifier("Arctic") // TODO Qualifier doesn't work need more investigation
public class ArcticBlockChainExplorer implements BlockChainExplorer {

	private final String URL = "http://explorer.arcticcoin.org/ext/getbalance/{address}";
